    ...
    >
      ...
      >
        ...
        <p className={classes.sisutekst}>
          ...
          Esimesel aastal alustasime kohe <i>HTML & CSS</i> õppimist, olin sellega varasemalt natuke kokku puutunud. Aine oli ülimalt põhjalik ja õppisin palju. Lisaks kasutasime erinevaid <i>Adobe</i> programme, enamus neist mulle juba tuttavad. <i>Adobe XD</i> oli uus, aga kasutamine väga raske ei ole. Lisaks kirjutasime natuke <i>JavaScripti</i>, olen ka natuke varasemalt kokku puutunud, aga siiani jäi segaseks. Tutvusime erinevate operatsioonisüsteemidega, lammutasime arvutit ja uurisime serverit.<br></br>
          Üks asi millega ma varem ei olnud kokku puutunud oli prototüüpimine, mulle meeldib seda teha, kuigi see on aeganõudev. Kasutasin ka esimest korda WordPressi, palju võimalusi erinevate asjade jaoks. Kasutajakogemuse tunnid olid kõige põnevamad, nüüd tean mis on <i>primary</i> ja <i>secondary</i> nupp!<br></br>
          Praktikal olin Saksamaal ettevõttes  <a className={classes.link} target="blank" href="https://www.juston.com/en/home_en/"> JustOn GmbH,</a> kus sain omandatud teadmisi kasutada. Koolis tegin kõik tööd <i>Adobe XD'ga</i> aga praktikal võtsin eesmärgiks kasutada ainult <i>Figma</i>, et ka see selgeks saaks. Vahepeal on tunne, et pole eriti midagi õppinud, aga tehtud töid vaadates näen, et miskit ikka jäi külge ja uusi teadmisi ning oskusi on omajagu.
      ...
      >
        ...
        <p className={classes.sisutekst}>
          Natuke kordasime eelmisel aastal Linuxiga õpitut ja kasutasime uusi käske terminalis. Lõime internetipanga prototüübi ja piilusime teisi prototüüpimise vahendeid. A/B testimise aines oli kõik täiesti uus.<br></br>
          ...
          Kuna kasutajakogemusega seotud ülesandeid oli vähe, siis otsustasin mitte kasutada sisuhaldussüsteeme (näiteks Google Sites või WordPress). Kirjutasin oma arenguportfoolio ise nullist valmis kasutades <i>HTML</i>, <i>CSS</i>, <i>JavaScript</i>, <i>React</i> ja <i>Material UI</i>. Kõigeks selleks kasutasin oma UX/UI teadmisi ja omandatud koodikirjutamise oskuseid. Lasin korduvalt oma loodud portfooliot testida tuttavatel, arendajal ja ka juhendajal. Saadud tagasiside põhjal viisin sisse täiendused ja parandused. Lisaks kasutan igapäevaselt ka oma töös <i>Material UI'd</i>, mis on kasutajaliidese disaini raamistik.<br></br>
